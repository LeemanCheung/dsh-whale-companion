...
export const TYPERT = {
  ...
  model: {
    "services": [
      {
        "description": "Local whale progression derived from event type, sequence, timestamp, and Session id only. Event contents never enter this service; recent receipt digests are intentionally bounded.",
        "summary": "Local whale progression derived from event type, sequence, timestamp, and Session id only.",
        "tags": [],
        ...
        "members": [
          ...
          },
          {
            "kind": "method",
            "name": "getV5",
            "signature": "@Remote('getV5') async getV5(): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "setSkin",
          ...
          },
          {
            "kind": "method",
            "name": "setSpecies",
            "signature": "@Remote('setSpeciesV5') async setSpecies(species: WhaleState['species']): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "placeCollectible",
            "signature": "@Remote('placeCollectibleV5') async placeCollectible(slot: string, collectible: string | null): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "saveRoomPreset",
            "signature": "@Remote('saveRoomPresetV5') async saveRoomPreset(): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "loadRoomPreset",
            "signature": "@Remote('loadRoomPresetV5') async loadRoomPreset(index: number): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "startExpedition",
            "signature": "@Remote('startExpeditionV5') async startExpedition(expeditionId: string, species: WhaleState['species'], goal: number): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "claimExpedition",
            "signature": "@Remote('claimExpeditionV5') async claimExpedition(): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "exportVisitorBottle",
            "signature": "@Remote('exportVisitorBottleV5') async exportVisitorBottle(): Promise<string>"
          },
          {
            "kind": "method",
            "name": "importVisitorBottle",
            "signature": "@Remote('importVisitorBottleV5') async importVisitorBottle(payload: string): Promise<WhaleVisitorBottle>"
          },
          {
            "kind": "method",
            "name": "setCommunity",
            "signature": "@Remote('setCommunityV5') async setCommunity(enabled: boolean, aliasId: string): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "exportCommunitySong",
            "signature": "@Remote('exportCommunitySongV5') async exportCommunitySong(): Promise<string>"
          },
          {
            "kind": "method",
            "name": "importCommunitySong",
            "signature": "@Remote('importCommunitySongV5') async importCommunitySong(payload: string): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "removeCommunityPeer",
            "signature": "@Remote('removeCommunityPeerV5') async removeCommunityPeer(aliasId: string): Promise<WhaleState>"
          },
          {
            "kind": "method",
            "name": "postcard",
            "signature": "@Remote('postcardV5') async postcard(): Promise<WhalePostcard>"
          },
          {
            "kind": "method",
            "name": "export",
        ...
        "types": [
          ...
          {
            "name": "WhalePostcard",
            "declaration": "export type WhalePostcard = Readonly<{ day: string; species: WhaleSpeciesId; skin: WhaleState['skin']; level: number; moments: readonly WhaleState['moments'][number][]; message: string; }>;"
          },
          {
            "name": "WhaleSpeciesId",
            "declaration": "export type WhaleSpeciesId = typeof whaleSpeciesId[number];"
          },
          {
            "name": "WhaleState",
            "declaration": "export type WhaleState = z.infer<typeof currentWhaleStateSchema>;"
          },
          {
            "name": "WhaleVisitorBottle",
            "declaration": "export type WhaleVisitorBottle = z.infer<typeof visitorBottleSchema>;"
          }
        ]
      }
    ],
