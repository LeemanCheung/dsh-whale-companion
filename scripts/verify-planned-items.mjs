...
const checks = [
  ...
  ['packages/dsh-whale-companion/src/client/WhaleArt.tsx', ['export function WhaleArt', 'data-raster-art', 'MINKE_SWIM_SPRITE']],
...
if (manifest.version !== '2.4.0') missing.push(`package.json: expected version 2.4.0, got ${manifest.version}`)
...
console.log('Verified every planned Whale Companion 2.4.0 delivery item.')
