...
if (manifest.version !== '2.3.0') missing.push(`package.json: expected version 2.3.0, got ${manifest.version}`)
...
console.log('Verified every planned Whale Companion 2.3.0 delivery item.')
