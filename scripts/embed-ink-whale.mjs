...
const motion = `data:image/webp;base64,${readFileSync(new URL('ink-breach-motion.webp', assets)).toString('base64')}`
const still = `data:image/png;base64,${readFileSync(new URL('ink-breach-still.png', assets)).toString('base64')}`
